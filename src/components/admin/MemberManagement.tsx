            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="reader">Reader - Can view and query documents</SelectItem>
                    <SelectItem value="contributor">Contributor - Can upload and manage documents</SelectItem>
                    <SelectItem value="admin">Admin - Full workspace permissions</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="hidden md:table-cell min-w-[120px]">Last Active</TableHead>
                <TableHead className="hidden lg:table-cell text-center min-w-[100px]">Documents</TableHead>
                <TableHead className="hidden lg:table-cell text-center min-w-[80px]">Queries</TableHead>
              ...
              <TableRow key={member.id}>
                ...
                <TableCell className="hidden lg:table-cell py-4 text-center">
                  <div className="flex items-center justify-center space-x-1">
                    ...
                    <span className="text-sm">{member.documentsUploaded}</span>
                  </div>
                </TableCell>
                <TableCell className="hidden lg:table-cell py-4 text-center">
