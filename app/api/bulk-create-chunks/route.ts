  ...
  try {
    ...
    for (const document of documentsToProcess) {
      ...
      try {
        ...
        const createChunksResponse = await fetch(`${req.nextUrl.origin}/api/create-chunks`, {
          method: "POST",
        ...
        console.log(`✅ ${document.title}: ${createChunksResult.chunksCreated || 0} chunks created`);
